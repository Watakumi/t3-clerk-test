...
export const jaJP: LocalizationResource = {
  ...
  formFieldLabel__signOutOfOtherSessions: "他のセッションからサインアウトする",
  ...
  formFieldError__matchingPasswords: "パスワードが一致しました",
  ...
  signUp: {
    start: {
      title: "アカウントを作成",
      subtitle: "アプリを遊ぶためにアカウントを作成してください",
  ...
  signIn: {
    start: {
      title: "ログイン",
      subtitle: "{{applicationName}} を続けるにはログインしてください",
      actionText: "アカウントをお持ちですか？",
      actionLink: "サインアップ",
      actionLink__use_email: "メールアドレスを使用する",
      actionLink__use_phone: "電話番号を使用する",
      actionLink__use_username: "ユーザー名を使用する",
      actionLink__use_email_username:
        "メールアドレスまたはユーザー名を使用する",
    },
    password: {
      title: "パスワードを入力してください",
      subtitle: "{{applicationName}} を続けるにはパスワードを入力してください",
      actionLink: "パスワードをお忘れですか？",
    },
    forgotPasswordAlternativeMethods: {
      title: "パスワードをリセット",
      label__alternativeMethods: "別の方法を使用する",
      blockButton__resetPassword: "パスワードをリセット",
    },
    forgotPassword: {
      title_email: "メールを確認してください",
      title_phone: "電話を確認してください",
      subtitle:
        "{{applicationName}} を続けるにはパスワードをリセットしてください",
      formTitle: "確認コード",
      formSubtitle_email:
        "メールアドレスに送信された確認コードを入力してください",
      formSubtitle_phone: "電話番号に送信された確認コードを入力してください",
    ...
    emailCode: {
      title: "メールを確認してください",
      subtitle: "{{applicationName}} を続けるにはメールを確認してください",
      formTitle: "確認コード",
